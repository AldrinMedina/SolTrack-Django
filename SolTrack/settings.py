"""
Django settings for SolTrack project.
...
load_dotenv()  # Only needed if you are using a local .env file
...
SECRET_KEY = 'django-insecure-m-if4jyg^gmr1c8a3x3q)2h!xb1_swj930wc&dlmbkk#h^ai)-'
...
WSGI_APPLICATION = 'SolTrack.wsgi.application'
